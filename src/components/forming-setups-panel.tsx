...
interface FormingSetupsPanelProps {
    setups: readonly FormingSetup[];
}

export function FormingSetupsPanel({ setups }: FormingSetupsPanelProps) {
    ...
    return (
        <section aria-label="Setups forming">
